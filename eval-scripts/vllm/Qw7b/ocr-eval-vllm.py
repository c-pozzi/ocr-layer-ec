...
MAX_CONCURRENT = 16  # Match original for best throughput
...
# For tables, use markdown format exactly like this:
# | Row label | Column 1 | Column 2 | Total |
# |-----------|----------|----------|-------|
# | data      | 1.0      | 2.0      | 3.0   |

# For regular text, preserve paragraphs and layout.
...
async def process_single_image(
    ...
    async with semaphore:
        ...
        payload = {
            ...
            "max_tokens": 8000,  # Back to 2048 like original
            "temperature": 0,
        }
